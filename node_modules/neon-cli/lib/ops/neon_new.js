    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!flag) {
                        return [2 /*return*/, { type: "version", value: NEON_CLI_VERSION }];
                    }
                    if (semver.valid(flag)) {
                        return [2 /*return*/, { type: "version", value: flag }];
                    }
                    if (semver.validRange(flag)) {
                        return [2 /*return*/, { type: "range", value: flag }];
                    }
                    return [4 /*yield*/, fs_1.stat(flag)];
                case 1:
                    stats = _a.sent();
                    if (!stats.isDirectory()) {
                        throw new Error("Specified path to Neon is not a directory");
                    }
                    return [2 /*return*/, { type: path.isAbsolute(flag) ? "absolute" : "relative", value: flag }];
            }
        });
    });
}
function wizard(pwd, name, neon, features, noDefaultFeatures) {
    return __awaiter(this, void 0, void 0, function () {
        var its, errors, scoped, _a, scope, local, root, guess, answers, neonVersion, simple, libs, neon_1, cli, ctx, lib, native_, src, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, relativeRoot, relativeNode, relativeRust;
        return __generator(this, function (_r) {
            switch (_r.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, parseNeonVersion(neon)];
                case 3:
                    neonVersion = _r.sent();
                    simple = (neonVersion.type === 'version' || neonVersion.type === 'range')
                        && !features
                        && !noDefaultFeatures;
                    libs = { simple: simple, noDefaultFeatures: noDefaultFeatures };
                    if (neonVersion.type === 'relative') {
                        neon_1 = path.relative(path.join(name, 'native'), neonVersion.value);
                        libs.paths = {
                            neon: JSON.stringify(neon_1),
                            'neon-build': JSON.stringify(path.join(neon_1, 'crates', 'neon-build'))
                        };
                    }
                    ...
                    cli = JSON.stringify(neonVersion.type === 'version'
                        ? "^" + neonVersion.value
                ...
                case 6: return [4 /*yield*/, _b.apply(void 0, _c.concat([(_r.sent())(ctx), { flag: 'wx' }]))];
                case 7:
                    _r.sent();
                    _d = fs_1.writeFile;
                    _e = [path.resolve(root, 'package.json')];
                    return [4 /*yield*/, NPM_TEMPLATE];
                case 8: return [4 /*yield*/, _d.apply(void 0, _e.concat([(_r.sent())(ctx), { flag: 'wx' }]))];
                case 9:
                    _r.sent();
                    _f = fs_1.writeFile;
                    _g = [path.resolve(native_, 'Cargo.toml')];
                    return [4 /*yield*/, CARGO_TEMPLATE];
                case 10: return [4 /*yield*/, _f.apply(void 0, _g.concat([(_r.sent())(ctx), { flag: 'wx' }]))];
                case 11:
                    _r.sent();
                    _h = fs_1.writeFile;
                    _j = [path.resolve(root, 'README.md')];
                    return [4 /*yield*/, README_TEMPLATE];
                case 12: return [4 /*yield*/, _h.apply(void 0, _j.concat([(_r.sent())(ctx), { flag: 'wx' }]))];
                case 13:
                    _r.sent();
                    _k = fs_1.writeFile;
                    _l = [path.resolve(root, answers.node)];
                    return [4 /*yield*/, INDEXJS_TEMPLATE];
                case 14: return [4 /*yield*/, _k.apply(void 0, _l.concat([(_r.sent())(ctx), { flag: 'wx' }]))];
                case 15:
                    _r.sent();
                    _m = fs_1.writeFile;
                    _o = [path.resolve(src, 'lib.rs')];
                    return [4 /*yield*/, LIBRS_TEMPLATE];
                case 16: return [4 /*yield*/, _m.apply(void 0, _o.concat([(_r.sent())(ctx), { flag: 'wx' }]))];
                case 17:
                    _r.sent();
                    _p = fs_1.writeFile;
                    _q = [path.resolve(native_, 'build.rs')];
                    return [4 /*yield*/, BUILDRS_TEMPLATE];
                case 18: return [4 /*yield*/, _p.apply(void 0, _q.concat([(_r.sent())(ctx), { flag: 'wx' }]))];
                case 19:
                    _r.sent();
